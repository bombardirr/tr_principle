export default {
  ...
  auth: {
    ...
    telegramHint: 'Required for password reset without email. Bot @appzac_bot.',
    ...
    telegramOpenLink: 'Open link again',
  },
  landing: {
    ...
    forgotHint: 'If Telegram is linked, a code goes to @appzac_bot. Otherwise contact an admin.',
    forgotSubmit: 'Send code',
    forgotSent: 'If the account exists and Telegram is linked, the code is in the bot. Enter it below.',
    resetTitle: 'New password',
    resetCodeField: 'Code from Telegram',
    newPasswordField: 'New password',
    resetSubmit: 'Save password',
    resetDone: 'Password updated. Sign in.',
    errorResetCode: 'Invalid or expired code.',
    emailField: 'Email',
