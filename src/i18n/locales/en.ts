export default {
  ...
  projects: {
    ...
    sharedWorksHint: 'All shared works where you are a member.',
  ...
  jobs: {
    ...
    cancel: 'Cancel',
    close: 'Close',
    createdNotice: 'Shared work created',
    ...
    copyNowHint: 'Copy this link now. The raw token is shown only once.',
    copy: 'Copy',
    copied: 'Copied',
    ...
    or: 'or',
    localProjectLabel: 'Local project copy',
    chooseLocalProject: 'Choose a project',
    selectedProject: 'Selected: {name}',
    noLocalProjects: 'No local projects. Import the package first.',
    importOverwrite: 'Replace the local project “{name}” with the imported copy?',
