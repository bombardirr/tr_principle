export default {
  ...
  editor: {
    ...
    thresholdLabel: 'TM match threshold',
    thresholdHint: 'TM match threshold — click to adjust',
    settingsFirstTitle: 'Project settings',
    settingsEditTitle: 'Language & TM',
    settingsHint: 'Choose the language pair and how strict TM matching should be.',
    settingsSave: 'Save',
