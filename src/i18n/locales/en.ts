export default {
  ...
  invites: {
    ...
    close: 'Close',
    acceptTitle: 'Joining project',
    accepting: 'Opening the shared project…',
    acceptError: 'Could not join this project.',
    ...
    viewer: 'Viewer',
    open: 'Open link',
    burning: 'One-time link',
    ttl: 'Expiring link',
    expires: 'Expires',
    expiresAt: 'Expires {date}',
    expiryRequired: 'Choose an expiration date and time.',
    uses: '{used} of {max} uses',
    create: 'Create link',
    latestLink: 'New invite link',
    copyLink: 'Copy link',
    copied: 'Copied',
    openInvites: 'Open links',
    burningInvites: 'One-time links',
    ttlInvites: 'Expiring links',
    noInvites: 'No active links',
    revoke: 'Revoke',
    members: 'Members',
    ...
    manageHint: 'Manage project collaborators and invite links',
  },
  projectTm: {
    title: 'Project translation memory',
    close: 'Close',
    manageHint: 'Manage project translation memory attachments',
    attachPersonal: 'Attach my personal TM',
    ownerHint: 'Only owners can change attachment permissions.',
    memberHint: 'Attachment permissions are managed by the project owner.',
