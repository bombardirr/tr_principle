...
- [x] **Яндекс.Метрика** на лендинге и в SPA (`VITE_YANDEX_METRIKA_ID`, без хардкода id в git)  
- [x] Базовые цели: register, login, project_open, export_docx (+ SPA hit)  
- [x] Privacy: без webvisor; не слать email/текст сегментов/JWT  
- [ ] Согласие / cookie-баннер — только если реально нужно по политике хостинга  
- [ ] В кабинете Метрики создать Goals с теми же именами (JS-событие)

Спека: [`docs/superpowers/specs/2026-07-24-yandex-metrika-design.md`](docs/superpowers/specs/2026-07-24-yandex-metrika-design.md)
