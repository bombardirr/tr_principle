...
6. **Фаза C: глоссарий** — C1 ✓; C2 ✓ named bases + job attach
7. **Фаза F: работа в группе** — новая спека **shared work / jobs** (личные копии + живые базы); старый co-edit F2.0 superseded  
8. Tag MVP  
...
**C2 ✓:** именованные базы, job attach с R/W/E/C, per-base sync; legacy bulk glossary sync удалён.

- [x] Спека C1 ✓ (файл выше)
- [x] Реализация C1
- [x] C2 — job / project attach
...
12. **Фаза F: группа** — shared work / jobs (J1→J4); co-edit F2.0 superseded  
