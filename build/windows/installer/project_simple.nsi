...
####
## Enhanced NSIS installer with shortcut options (simplified version)
####
...
Function ShortcutOptionsPage
   ...
   ${NSD_CreateLabel} 10 80 100% 40u "Note: You can manually pin the application to taskbar after installation by right-clicking the desktop shortcut and selecting 'Pin to taskbar'."
